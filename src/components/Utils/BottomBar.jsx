...
function BottomBar({
  ...
  return (
    <div className={styles.bottomBar}>
      <button className={styles.bottomBar__button}></button>
      <button
        className={`${styles.bottomBar__button} ${styles['bottomBar__button--main']}`}
      ...
      <motion.button
        className={`${styles.bottomBar__button} ${
          isViewingSettings ? styles['bottomBar__button--active'] : ''
        }`}
        whileTap={{ scale: 0.98 }}
